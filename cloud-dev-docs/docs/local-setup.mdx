...
```bash
ssh -p 3434 <your-username>@<server-ip>
```
    ...
    "settings": {
        ...
        "emeraldwalk.runonsave": {
            "commands": [
                {
                    "match": ".*",
                    "cmd": "rsync -avz --delete -e 'ssh -p 3434' /Users/<your-username>/Code/my-project/ <your-username>@<server-ip>:/projects/my-project/"
                }
            ]
        }
    }
    ...
    "settings": {
        ...
        "emeraldwalk.runonsave": {
            "commands": [
                {
                    "match": ".*",
                    "cmd": "rsync -avz --delete -e 'ssh -p 3434' /home/<your-username>/Code/my-project/ <your-username>@<server-ip>:/projects/my-project/"
                }
            ]
        }
    }
