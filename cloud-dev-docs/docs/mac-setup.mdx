...
You don't need a Mac. Everything works server-side — browser-based desktop, VS Code, and SSH from any device. This page covers optional local editing with automatic sync to the server.
...
- SSH creates a socket file at `~/.ssh/sockets/<your-username>@<ip>-3434`
    ...
    "settings": {
        ...
        "emeraldwalk.runonsave": {
            "commands": [
                {
                    "match": ".*",
                    "cmd": "rsync -avz --delete -e 'ssh -p 3434' /Users/<your-username>/Code/my-project/ <your-username>@<casaos-ip>:/projects/my-project/"
                }
            ]
        }
    }
